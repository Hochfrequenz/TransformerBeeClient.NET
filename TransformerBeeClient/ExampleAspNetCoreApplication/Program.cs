...
app.MapGet("/", () => "I ❤ BO4E");
app.MapGet("/talkToTransformerBee", async (HttpContext context, ICanConvertToBo4e transformerBeeRestClient) =>
{
    ...
    var json = JsonSerializer.Serialize(result, new JsonSerializerOptions(){Converters = { new JsonStringEnumConverter()} });
